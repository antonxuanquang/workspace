...
{
	private static String URL = "https://translate.google.com/translate_a/t?client=t&text={text}&hl=zh-CN&sl={source}&tl={target}&ie=UTF-8&oe=UTF-8&multires=1&prev=conf&psl=zh-CN&ptl=zh-CN&otf=1&it=sel.6041&ssel=0&tsel=0&sc=1";
