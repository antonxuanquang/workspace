...
{	
	public EntityDaoRdbOracle(EntityEntity entity, DataSource dataSource, boolean showSql)
	{
		super(entity, dataSource, showSql);
	}

	@Override
	protected List<Object> getIdList(List<Condition> conds, List<Order> orders, int start, int amount)
	{
		return null;
	}
