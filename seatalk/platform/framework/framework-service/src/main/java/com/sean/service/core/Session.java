...
public abstract class Session
{
	...
	protected ResultState state = ResultState.Success;
	...
	/**
	 * set loginer infomation，external package is access denied
	 * @param sessionId sessionId，is meaningless
	 * @param userId userId
	 */
	public void setLoginInfo(long sessionId, long userId)
	{
		if (this.sessionId == -1)
		{
