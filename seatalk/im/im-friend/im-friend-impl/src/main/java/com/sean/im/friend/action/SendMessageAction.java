...
@ActionConfig(description = "发送消息", authenticate = false, 
mustParams = { P.loginerId, Params.receiverId, Params.content })
public class SendMessageAction extends Action
{
	...
	public void execute(Session session) throws Exception
	{
		...
		msi.sendTextMessage(loginerId, receiverId, content, loginerId);
		msi.sendTextMessage(loginerId, receiverId, content, receiverId);
