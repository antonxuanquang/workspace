...
@ActionConfig(description = "收回群管理员", authenticate = false, 
mustParams = { P.loginerId, Params.flockMemberId })
public class TakeBackFlockAdminAction extends Action
{
	@ResourceConfig
	...
	public void execute(Session session) throws Exception
	{
		...
		fsi.manageFlockAdmin(loginerId, flockMemberId, false);
